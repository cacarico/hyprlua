...
--- Adds a monitor and optionally its workspaces
...
--- @param position (string) The position where the monitor will be displayed
--- @param scale (string) The scale for the monitor
